...
class _HostelSignupScreenState extends State<HostelSignupScreen> {
  ...
  //List<String> _hostelImages = []; // Initialize the list

  Future<void> _selectHostelImages() async {
    ...
    if (pickedImages == null) {
      ...
      setState(() {
        _hostelImages.addAll(selectedImages);
      });
    }
  }
                    ...
                    ..._hostelImages.map((imagePath) {
                      return Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: Image.asset(
                            'hostel1.jpg', // Use the asset path
                            fit: BoxFit.cover,
                          ),
                        ),
                      );
